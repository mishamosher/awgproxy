...
If you want to disable the extensive logging that's done by awgproxy, simply add `-s` parameter to `ExecStart=`. This will enable the silent mode that was implemented with [pull/67](https://github.com/windtf/wireproxy/pull/67).
